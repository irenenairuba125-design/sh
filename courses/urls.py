...
urlpatterns = [
    ...
    path('teach/<int:course_id>/edit/', views.edit_course, name='edit_course'),
    path('teach/<int:course_id>/delete/', views.delete_course, name='delete_course'),
    path('teach/lesson/<int:lesson_id>/delete/', views.delete_lesson, name='delete_lesson'),
